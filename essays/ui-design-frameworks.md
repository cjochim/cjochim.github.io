...
<img width="300px" class="rounded float-start pe-4" src="../img/bootstrapbrowserhist.png">
<img width="300px" class="rounded float-end pe-4" src="../img/cssbrowserhist.png">
